...
var BootstrapPaginatorComponent = /** @class */ (function () {
    function BootstrapPaginatorComponent() {
    ...
    return BootstrapPaginatorComponent;
}());
...
var SorterComponent = /** @class */ (function () {
    function SorterComponent(page) {
        this.page = page;
    }
    SorterComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.page.sortChange.subscribe(function (sort) {
            console.error('bbb', _this.by, sort.toString());
            var index = _this.page.sort.indexOf(_this.by);
            if (index !== -1 && _this.page.sort.length > index + 1) {
                _this.sortBy = _this.page.sort[index + 1];
                console.error('ccc', _this.by, _this.sortBy);
            }
            else {
                _this.sortBy = '';
            }
...
var PageDirective = /** @class */ (function () {
    function PageDirective(differs) {
    ...
    Object.defineProperty(PageDirective.prototype, "data", {
        get: function () {
    ...
    Object.defineProperty(PageDirective.prototype, "zzPage", {
        set: function (page) {
            if (!page) {
                return;
            }
    ...
    PageDirective.prototype.ngOnInit = function () {
        var _this = this;
        this.pageChange.subscribe(function (res) {
            if (_this.allData) {
                _this.fillData();
            }
        });
    };
    PageDirective.prototype.setPage = function (page, size) {
    ...
    PageDirective.prototype.calculateNewActivePage = function (previousRowsOnPage, currentRowsOnPage) {
        var firstRowOnPage = (this.page.page - 1) * previousRowsOnPage + 1;
        return Math.ceil(firstRowOnPage / currentRowsOnPage);
    };
    PageDirective.prototype.setSort = function (name, sort) {
        if (sort === void 0) { sort = ''; }
    ...
    PageDirective.prototype.fillData = function () {
        var _this = this;
        var lastPage = Math.ceil(this.allData.length / this.page.size);
        this.page.page = lastPage < this.page.page ? lastPage : this.page.page;
        this.page.page = this.page.page || 1;
        var offset = (this.page.page - 1) * this.page.size;
        var data = this.allData;
        var sortBy = this.sort;
        if (sortBy.length > 0) {
            this.sort = this.sort.slice(sortBy.length - 2);
            this.sortChange.next(this.sort);
            data = new (Array.bind.apply(Array, [void 0].concat(data)))().sort(function (a, b) {
                var delta = a[_this.sort[0]] >= b[_this.sort[0]];
                return _this.sort[1] === 'asc' && delta ? 0 : -1;
            });
        }
...
var comp = [_directives_page_directive__WEBPACK_IMPORTED_MODULE_5__["PageDirective"], _components_paginator_paginator_component__WEBPACK_IMPORTED_MODULE_2__["PaginatorComponent"], _components_bootstrap_paginator_bootstrap_paginator_component__WEBPACK_IMPORTED_MODULE_3__["BootstrapPaginatorComponent"]];
var NgxDatatableModule = /** @class */ (function () {
    function NgxDatatableModule() {
    }
    NgxDatatableModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: comp.concat([_components_sorter_sorter_component__WEBPACK_IMPORTED_MODULE_7__["SorterComponent"]]),
            ...
            exports: comp.concat([_components_sorter_sorter_component__WEBPACK_IMPORTED_MODULE_7__["SorterComponent"]])
        })
    ], NgxDatatableModule);
