BaseService.factory('StorageService', function ($rootScope, $cookieStore, $cookies, $window)
{
  try {
    return {
      //获得全局变量
      ...
      setCookie: function (key, value)
      {
        ...
        var Days = 1;
        var exp  = new Date();
        exp.setTime(exp.getTime() + Days * 24 * 60 * 60 * 1000); // 有效期1天
        document.cookie = encodeURIComponent(key) + '=' + encodeURIComponent(value) +
          ';expires=' + exp.toGMTString() + ';path=/;domain=51qiguai.com';
      ...
      {
        $cookieStore.put(key, json_object);
